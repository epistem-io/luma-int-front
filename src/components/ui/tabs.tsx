  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        "p-1 rounded-[12px] border border-neutral-400 bg-neutral-200",
        className,
      )}
      {...props}
    />
